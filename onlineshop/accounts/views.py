...
class UserRegisterView(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            messages.success(request, "send you a code", "success")
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            if cd["code"] == code_instance.code:
                ...
                messages.success(request, "you register successfuly", "success")
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            if user is not None:
                ...
                return redirect("home:home")
            messages.error(request, "phone number or password is not true", "warning")
